	...
	public boolean use(Dungeon dungeon) {
		POTIONS: while (true) {
			...
			if (potCrafting == 1) {// Read dormitory
                ...
                dungeon.println(Style.CENTER, "You dont have flashk to full up with lektvar.");
                continue POTIONS;
				...
				if (dungeon.getForAll().frogHeart >= 1 && dungeon.getForAll().worm >= 2) {
                    ...
                    dungeon.println(Style.CENTER, "You dont have enough ingredience to create small health potion.");
                }
				...
				if (dungeon.getForAll().frogHeart >= 2 && dungeon.getForAll().worm >= 2) {
                    ...
                    dungeon.println(Style.CENTER, "You dont have enough ingredience to create medium health potion.");
                }
				...
				if (dungeon.getForAll().frogHeart >= 3 && dungeon.getForAll().worm >= 4) {
                    ...
                    dungeon.println(Style.CENTER, "You dont have enough ingredience to create large health potion.");
                }
				...
				if (dungeon.getForAll().frogLeftEye >= 1 && dungeon.getForAll().frogLeg >= 4) {
                    ...
                    dungeon.println(Style.CENTER, "You dont have enough ingredience to create teleport potion.");
                }
				...
				if (dungeon.getForAll().sneakBrain >= 1 && dungeon.getForAll().squirelTails >= 2
                    ...
                    dungeon.println(Style.CENTER, "You dont have enough ingredience to potion of concentration.");
                }
