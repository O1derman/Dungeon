		...
		POTIONS: while (true) {
			...
			if (potCrafting == 1) {// Read dormitory
				...
				if (dungeon.getForAll().sneakBrain >= 1 && dungeon.getForAll().squirelTails >= 2
					...
					dungeon.printlnMiddle("You created a potion of concentration.");
					...
					dungeon.printlnMiddle("You dont have enough ingredience to potion of concentration.");
				}
